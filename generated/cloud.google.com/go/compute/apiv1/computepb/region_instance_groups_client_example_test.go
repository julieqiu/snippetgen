...
func ExampleNewRegionInstanceGroupsClient() {
	...
	c, err := computepb.NewRegionInstanceGroupsClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
...
func ExampleRegionInstanceGroupsClient_ListInstances() {
	...
	req := &computepb.ListInstancesRegionInstanceGroupsRequest{
		...
		Project: "",
		Region: "",
		RegionInstanceGroupsListInstancesRequestResource: &computepb.RegionInstanceGroupsListInstancesRequest{
			InstanceState: "",
			PortName: "",
		}
		ReturnPartialSuccess: "",
...
func ExampleRegionInstanceGroupsClient_SetNamedPorts() {
	...
	req := &computepb.SetNamedPortsRegionInstanceGroupRequest{
		...
		Project: "",
		Region: "",
		RegionInstanceGroupsSetNamedPortsRequestResource: &computepb.RegionInstanceGroupsSetNamedPortsRequest{
			Fingerprint: "",
