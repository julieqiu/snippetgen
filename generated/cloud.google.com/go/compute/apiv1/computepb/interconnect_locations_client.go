...
func defaultInterconnectLocationsGRPCClientOptions() []option.ClientOption {
...
func defaultInterconnectLocationsCallOptions() *InterconnectLocationsCallOptions {
...
// interconnectLocationsGRPCClient is a client for interacting with Google Compute Engine API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type interconnectLocationsGRPCClient struct {
	...
	// The gRPC API client.
	interconnectLocationsClient computepb.InterconnectLocationsClient

	// The x-goog-* metadata to be sent with each request.
	xGoogHeaders []string
}

// NewInterconnectLocationsClient creates a new interconnect locations client based on gRPC.
// The returned client must be Closed when it is done being used to clean up its underlying connections.
//
// The InterconnectLocations API.
func NewInterconnectLocationsClient(ctx context.Context, opts ...option.ClientOption) (*InterconnectLocationsClient, error) {
	clientOpts := defaultInterconnectLocationsGRPCClientOptions()
	if newInterconnectLocationsClientHook != nil {
		hookOpts, err := newInterconnectLocationsClientHook(ctx, clientHookParams{})
		if err != nil {
			return nil, err
		}
	...
	client := InterconnectLocationsClient{CallOptions: defaultInterconnectLocationsCallOptions()}

	c := &interconnectLocationsGRPCClient{
		connPool:    connPool,
		interconnectLocationsClient: computepb.NewInterconnectLocationsClient(connPool),
...
// Deprecated: Connections are now pooled so this method does not always
// return the same resource.
func (c *interconnectLocationsGRPCClient) Connection() *grpc.ClientConn {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *interconnectLocationsGRPCClient) setGoogleClientInfo(keyval ...string) {
...
// Close closes the connection to the API service. The user should invoke this when
// the client is no longer required.
func (c *interconnectLocationsGRPCClient) Close() error {
	return c.connPool.Close()
}

func (c *interconnectLocationsGRPCClient) Get(ctx context.Context, req *computepb.GetInterconnectLocationRequest, opts ...gax.CallOption) (*computepb.InterconnectLocation, error) {
	...
	var resp *computepb.InterconnectLocation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.interconnectLocationsClient.Get(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *interconnectLocationsGRPCClient) List(ctx context.Context, req *computepb.ListInterconnectLocationsRequest, opts ...gax.CallOption) *InterconnectLocationIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*computepb.InterconnectLocation, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = c.interconnectLocationsClient.List(ctx, req, settings.GRPC...)
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
