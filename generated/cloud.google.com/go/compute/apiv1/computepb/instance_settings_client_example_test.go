...
func ExampleNewInstanceSettingsClient() {
	...
	c, err := computepb.NewInstanceSettingsClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
...
func ExampleInstanceSettingsClient_Patch() {
	...
	req := &computepb.PatchInstanceSettingRequest{
		InstanceSettingsResource: &computepb.InstanceSettings{
			Fingerprint: "",
			Kind: "",
			Metadata: &computepb.InstanceSettingsMetadata{
				Items: "",
				Kind: "",
			}
			Zone: "",
