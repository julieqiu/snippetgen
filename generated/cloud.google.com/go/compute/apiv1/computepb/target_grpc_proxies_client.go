...
func defaultTargetGrpcProxiesGRPCClientOptions() []option.ClientOption {
...
func defaultTargetGrpcProxiesCallOptions() *TargetGrpcProxiesCallOptions {
...
// targetGrpcProxiesGRPCClient is a client for interacting with Google Compute Engine API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type targetGrpcProxiesGRPCClient struct {
	...
	// The gRPC API client.
	targetGrpcProxiesClient computepb.TargetGrpcProxiesClient

	// The x-goog-* metadata to be sent with each request.
	xGoogHeaders []string
}

// NewTargetGrpcProxiesClient creates a new target grpc proxies client based on gRPC.
// The returned client must be Closed when it is done being used to clean up its underlying connections.
//
// The TargetGrpcProxies API.
func NewTargetGrpcProxiesClient(ctx context.Context, opts ...option.ClientOption) (*TargetGrpcProxiesClient, error) {
	clientOpts := defaultTargetGrpcProxiesGRPCClientOptions()
	if newTargetGrpcProxiesClientHook != nil {
		hookOpts, err := newTargetGrpcProxiesClientHook(ctx, clientHookParams{})
		if err != nil {
			return nil, err
		}
	...
	client := TargetGrpcProxiesClient{CallOptions: defaultTargetGrpcProxiesCallOptions()}

	c := &targetGrpcProxiesGRPCClient{
		connPool:    connPool,
		targetGrpcProxiesClient: computepb.NewTargetGrpcProxiesClient(connPool),
...
// Deprecated: Connections are now pooled so this method does not always
// return the same resource.
func (c *targetGrpcProxiesGRPCClient) Connection() *grpc.ClientConn {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *targetGrpcProxiesGRPCClient) setGoogleClientInfo(keyval ...string) {
...
// Close closes the connection to the API service. The user should invoke this when
// the client is no longer required.
func (c *targetGrpcProxiesGRPCClient) Close() error {
	return c.connPool.Close()
}

func (c *targetGrpcProxiesGRPCClient) Delete(ctx context.Context, req *computepb.DeleteTargetGrpcProxyRequest, opts ...gax.CallOption) (*computepb.Operation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.targetGrpcProxiesClient.Delete(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *targetGrpcProxiesGRPCClient) Get(ctx context.Context, req *computepb.GetTargetGrpcProxyRequest, opts ...gax.CallOption) (*computepb.TargetGrpcProxy, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v&%s=%v", "project", url.QueryEscape(req.GetProject()), "target_grpc_proxy", url.QueryEscape(req.GetTargetGrpcProxy()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).Get[0:len((*c.CallOptions).Get):len((*c.CallOptions).Get)], opts...)
	var resp *computepb.TargetGrpcProxy
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.targetGrpcProxiesClient.Get(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *targetGrpcProxiesGRPCClient) Insert(ctx context.Context, req *computepb.InsertTargetGrpcProxyRequest, opts ...gax.CallOption) (*computepb.Operation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.targetGrpcProxiesClient.Insert(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *targetGrpcProxiesGRPCClient) List(ctx context.Context, req *computepb.ListTargetGrpcProxiesRequest, opts ...gax.CallOption) *TargetGrpcProxyIterator {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "project", url.QueryEscape(req.GetProject()))}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*computepb.TargetGrpcProxy, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = c.targetGrpcProxiesClient.List(ctx, req, settings.GRPC...)
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *targetGrpcProxiesGRPCClient) Patch(ctx context.Context, req *computepb.PatchTargetGrpcProxyRequest, opts ...gax.CallOption) (*computepb.Operation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v&%s=%v", "project", url.QueryEscape(req.GetProject()), "target_grpc_proxy", url.QueryEscape(req.GetTargetGrpcProxy()))}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.targetGrpcProxiesClient.Patch(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
