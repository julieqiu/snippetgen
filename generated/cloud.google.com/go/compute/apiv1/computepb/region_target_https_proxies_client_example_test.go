...
func ExampleNewRegionTargetHttpsProxiesClient() {
	...
	c, err := computepb.NewRegionTargetHttpsProxiesClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
...
func ExampleRegionTargetHttpsProxiesClient_SetSslCertificates() {
	...
	req := &computepb.SetSslCertificatesRegionTargetHttpsProxyRequest{
		Project: "",
		Region: "",
		RegionTargetHttpsProxiesSetSslCertificatesRequestResource: &computepb.RegionTargetHttpsProxiesSetSslCertificatesRequest{
			SslCertificates: "",
		}
		RequestId: "",
		TargetHttpsProxy: "",
