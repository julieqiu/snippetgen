...
func ExampleNewPublicAdvertisedPrefixesClient() {
	...
	c, err := computepb.NewPublicAdvertisedPrefixesClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
...
func ExamplePublicAdvertisedPrefixesClient_Insert() {
	...
	req := &computepb.InsertPublicAdvertisedPrefixeRequest{
		Project: "",
		PublicAdvertisedPrefixResource: &computepb.PublicAdvertisedPrefix{
			ByoipApiVersion: "",
			CreationTimestamp: "",
			Description: "",
			DnsVerificationIp: "",
			...
			Name: "",
			PdpScope: "",
			PublicDelegatedPrefixs: &computepb.PublicAdvertisedPrefixPublicDelegatedPrefix{
				IpRange: "",
				Name: "",
				Project: "",
				Region: "",
