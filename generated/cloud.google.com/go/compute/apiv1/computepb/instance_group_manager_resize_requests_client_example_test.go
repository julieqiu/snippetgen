...
func ExampleNewInstanceGroupManagerResizeRequestsClient() {
	...
	c, err := computepb.NewInstanceGroupManagerResizeRequestsClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
...
func ExampleInstanceGroupManagerResizeRequestsClient_Insert() {
	...
	req := &computepb.InsertInstanceGroupManagerResizeRequestRequest{
		InstanceGroupManager: "",
		InstanceGroupManagerResizeRequestResource: &computepb.InstanceGroupManagerResizeRequest{
			CreationTimestamp: "",
			Description: "",
			Id: "",
			Kind: "",
			Name: "",
			RequestedRunDuration: &computepb.Duration{
				Nanos: "",
				Seconds: "",
			}
			ResizeBy: "",
			...
			SelfLinkWithId: "",
			State: "",
			Status: &computepb.InstanceGroupManagerResizeRequestStatus{
				Error: &computepb.Error{...}
				LastAttempt: &computepb.InstanceGroupManagerResizeRequestStatusLastAttempt{...}
			}
			Zone: "",
		}
		Project: "",
